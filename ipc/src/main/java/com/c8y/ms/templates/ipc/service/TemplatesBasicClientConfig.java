...
public class TemplatesBasicClientConfig {
	...
	@Autowired
	public TemplatesBasicClientConfig(ContextService<UserCredentials> userContextService, ContextService<MicroserviceCredentials> microserviceContextService, CumulocityClientProperties clientProperties) {
